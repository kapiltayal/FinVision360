...
- [Authenticated page scrolling](authenticated-page-scrolling.md) — authenticated pages use document scrolling so content and footer remain in one continuous flow.
