  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div
        ...
        style={{ background: "linear-gradient(120deg, #071a2b 0%, #0a3d6b 30%, #1060a0 58%, #0d2e47 80%, #071a2b 100%)" }}
      >
      ...
      <div className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 max-w-7xl mx-auto">
        ...
        {/* ── Recommendations ── */}
        <SnapshotCard title="Financial Recommendations" accent="#6366f1" icon={Lightbulb} className="md:col-span-2">
