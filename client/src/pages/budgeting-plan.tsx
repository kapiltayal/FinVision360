  ...
  return (
    <div className="relative ml-auto w-36">
      ...
      <Input
        ...
        className="h-9 pl-7 pr-8 text-right tabular-nums"
...
export default function BudgetingPlanPage() {
  ...
  }, [actualMap, data?.actuals, data?.plans, planMap]);
    ...
    <div className="mx-auto max-w-7xl space-y-6 p-4 md:p-6">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant={month === currentMonth ? "default" : "secondary"}>
                {month === currentMonth ? "Current month" : "Historical month"}
              </Badge>
            </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex flex-col gap-2 rounded-lg border border-blue-200 bg-blue-50/70 p-4 dark:border-blue-900/60 dark:bg-blue-950/20 sm:flex-row sm:items-center sm:justify-between">
            <div>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="border-b bg-rose-500/[0.06] py-4">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <CardTitle className="flex items-center gap-2 text-base">
          ...
          <Card className="overflow-hidden">
            <CardHeader className="border-b bg-violet-500/[0.06] py-4">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <CardTitle className="flex items-center gap-2 text-base">
          ...
          <Card className="border-blue-200 bg-gradient-to-r from-blue-50 to-sky-50 dark:border-blue-900/60 dark:from-blue-950/30 dark:to-sky-950/20">
            <CardContent className="grid gap-4 p-5 sm:grid-cols-3">
              <div>
                <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
                  Planned income
                </p>
                <p className="mt-1 text-xl font-bold">{formatCurrency(plannedIncome)}</p>
              </div>
              <div>
                <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
                  Planned outflows
                </p>
                <p className="mt-1 text-xl font-bold">{formatCurrency(plannedOutflows)}</p>
              </div>
              <div>
                <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
